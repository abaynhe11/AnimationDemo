package com.sriyank.animationsdemo.adapters
...
class AnimationRecyclerAdapter(context: Context, private var dataList: MutableList<Landscape>) : RecyclerView.Adapter<AnimationRecyclerAdapter.MyViewHolder>() {
